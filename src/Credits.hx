...
class Credits extends Process {
	...
	public function new() {
        ...
        addText("Benjamin Tissot - New Dawn", Assets.fontSmall);
        addText("Benjamin Tissot - Deep Blue", Assets.fontSmall);
        addText("Available at https://www.bensound.com/royalty-free-music/", Assets.fontSmall);
        flow.addSpacing(50);
